...
const DynamicMonthPage = () => {
  ...
  const openPopup = async (date) => {
    ...
    const dataPath = `users/${userID}/${month}/${date}/data`;
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      for (let day = 1; day <= daysInMonth; day++) {
        const sumOfDayPath = `users/${userID}/${month}/${day}/data/sumOfDay`;
        const sumOfDayRef = ref(database, sumOfDayPath);

        const promise = new Promise((resolve, reject) => {
          onValue(
            sumOfDayRef,
            (snapshot) => {
              const sumOfDayValue = snapshot.val();
              resolve(sumOfDayValue);
            },
            (error) => {
              reject(error);
            }
      ...
      try {
        ...
        results.forEach((sumOfDayValue) => {
          totalSum += sumOfDayValue || 0;
        });
        setSumOfMonth(totalSum);
      } catch (error) {
  ...
  const handleSave = () => {
    ...
    const database = getDatabase();
    const dataPath = `users/${userID}/${month}/${selectedDate}/data`;
  ...
  const hemalupdate = () => {
    const totalll =
      parseFloat(values["row1-item1"]) * parseFloat(values["row1-item2"]) +
  ...
  return (
    <div style={{display:"flex",flexDirection:"column", justifyContent:"center", alignContent:"center"}}>
      <h1
        style={{ marginLeft: "60px", fontWeight: "lighter", fontSize: "30px", color: "#92a8c9" }}
      >
        {" "}
        {monthName}
      </h1>
      <h1
        style={{ marginLeft: "60px", fontWeight: "lighter", fontSize: "25px", color: "#92a8c9" }}
      >
        Total Salary: {sumOfMonth}
      </h1>
      <div className={styles.buttonContainer} style={{marginLeft:"20px", marginTop:"20px", marginRight:"20px"}}>
          ...
          <div className={styles.container}>
            <div className={styles.row}>
              <div className={styles.inputGroup}>
                <input className={styles.inputField} value="Type" readOnly />
              </div>
              <div className={styles.inputGroup}>
                <input
              ...
              <div className={styles.inputGroup}>
                <input className={styles.inputField} value="Price" readOnly />
              </div>
              <div className={styles.inputGroup}>
                <input className={styles.inputField} value="Total" readOnly />
              </div>
            </div>

            <div className={styles.row}>
              <div className={styles.inputGroup}>
                <input className={styles.inputField} value="A" readOnly />
              </div>
              <div className={styles.inputGroup}>
            ...
            <div className={styles.row}>
              <div className={styles.inputGroup}>
                <input className={styles.inputField} value="B" readOnly />
              </div>
              <div className={styles.inputGroup}>
            ...
            <div className={styles.row}>
              <div className={styles.inputGroup}>
                <input className={styles.inputField} value="C" readOnly />
              </div>
              <div className={styles.inputGroup}>
            ...
            <div className={styles.row}>
              <div className={styles.inputGroup}>
                <input className={styles.inputField} value="D" readOnly />
              </div>
              <div className={styles.inputGroup}>
            ...
            <div className={styles.row}>
              <div className={styles.inputGroup}>
                <label htmlFor="total" style={{color:"whitesmoke", padding:"2px"}}>SumOfDay</label>
                <input
                  className={styles.inputField}
                  type="text"
                  id="total"
